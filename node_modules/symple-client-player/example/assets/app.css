...
#video .local-video-wrap .symple-player {
  height: 96px;
}
#video .remote-video-wrap {
  height: 400px;
}
#video .remote-video-wrap .symple-player {
  height: 400px;
  max-width: 100%;
}
...
#video .symple-player-status,
#video .symple-player-controls {
  display: none;
}
